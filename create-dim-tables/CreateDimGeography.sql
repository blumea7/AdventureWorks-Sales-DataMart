...
CREATE TABLE dbo.DimGeography (
	...
	CONSTRAINT PK_DimGeography_AddressID PRIMARY KEY CLUSTERED (GeographyUniqueID ASC)
)

-- Populate Geography dimension table
INSERT INTO dbo.DimGeography
SELECT DISTINCT
	-- GeographyUniqueID  // no need to populate since automatically generated by sql server
	 City = pa.City
